                                ...
                                children: [
                                  Expanded(
                                    child: BlocConsumer<MainCubit, MainStates>(
                                      listener: (context, state) {
                                        if (state
                                            is UploadProposalsSuccessState) {
                                          showToast(
                                              message: "Uploaded Successfully");
                                        }
                                        if (state
                                            is UploadProposalsErrorState) {
                              ...
                              Column(
                                children: [
                                  Expanded(
                                    child: BlocProvider(
                                      create: (context) =>
                                          sl<InviteActionsCubit>(),
                                      child: BlocConsumer<InviteActionsCubit,
                                          InviteActionsState>(
                                        listener: (context, state) {
                                          if (state
